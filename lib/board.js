...
//   message  -> a few words about them. Leave "" and the page writes a default.
...
export function videoEmbed(url) {
  ...
  if (ig) {
    return { kind: "iframe", src: "https://www.instagram.com/reel/" + ig[1] + "/embed/", label: "Watch on Instagram", fallback: u };
  }
