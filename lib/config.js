...
export const ACTIVATIONS = [
  ...
  },
  {
    ...
    long: "Nourished and gathered, we move into live performance. Music and spoken word from artists whose sound carries a message - frequencies meant to activate, not just entertain. The full lineup is being confirmed.",
    people: [],
  },
  {
    id: "dance",
    ...
    long: "A guided dance experience led by our choreographers - a journey through rhythms and movement traditions from across the diaspora. No experience needed, just presence and a willingness to move. Choreographers being confirmed.",
    people: [],
  },
  {
    id: "fashion",
