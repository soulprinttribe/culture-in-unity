...
export const ACTIVATIONS = [
  ...
  },
  {
    ...
    long: "We close the arc with live performance. Music and spoken word from artists whose sound carries a message - frequencies meant to activate, not just entertain. The full lineup is being confirmed.",
    people: [],
  },
  {
    id: "art",
